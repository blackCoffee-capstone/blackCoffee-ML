...
class HybridRecSystem(torch.nn.Module):
    def __init__(
        ...
        self.user_embedding    = torch.nn.Embedding(number_of_user, embedding_size)
        self.item_embedding    = torch.nn.Embedding(number_of_item, embedding_size)
